...
\usepackage{amssymb,amsmath,amsfonts,bm,latexsym,amscd,verbatim,url,nicefrac,stmaryrd,enumerate,colonequals}
\usepackage[all]{xy}
\usepackage[letterpaper, left=3cm, right=3cm, height=22cm]{geometry}
...
\hfuzz=2pt
\vfuzz=2pt
\newtheorem{theorem}{Theorem}{\bf}{\it}\newtheorem{thm}{Theorem}{\bf}{\it}%\spnewtheorem{warning}[thm]{Warning}{\bf}{}
...
\theoremstyle{remark}
\newtheorem{exm}[thm]{Example}%\spnewtheorem{df}[thm]{Definition}{\bf}{}%\spnewtheorem{exam}[thm]{Example}{\bf}{}
...
\newcommand{\catt}{\mathbf{T}}%{\mathscr{D}}
\newcommand{\ox}{\mathcal{O}_X}
\newcommand{\fu}{\mathbb{F}_1}
...
%\DeclareMathOperator{\Sha}{\char{\fontencoding{OT2}\selectfont\char88}}
%\DeclareMathSymbol{\Sha}{\mathalpha}{cyrletters}{"58}
%\DeclareMathSymbol{\Sha}{\fontencoding{OT2}\selectfont SH}
%\def\Sha{{\fontencoding{OT2}\selectfont SH}}
%\def\sha{{\fontencoding{OT2}\selectfont sh}}
\newcommand{\adj}[4]{#1\negmedspace: #2\rightleftarrows #3:\negmedspace #4}

\DeclareMathOperator{\AdicSm}{AdicSm}
\DeclareMathOperator{\alg}{alg}
\DeclareMathOperator{\Ann}{Ann}
\DeclareMathOperator{\colim}{colim}
\DeclareMathOperator{\Der}{Der}
\DeclareMathOperator{\ffor}{for}
\DeclareMathOperator{\FormDM}{\bf{FormDM}}
\DeclareMathOperator{\Frac}{Frac}
\DeclareMathOperator{\Gal}{Gal}
\DeclareMathOperator{\gr}{gr}
\DeclareMathOperator{\Hom}{Hom}
\DeclareMathOperator{\HHom}{\bf{Hom}}
...
\DeclareMathOperator{\Perf}{Perf}
\DeclareMathOperator{\PerfSm}{PerfSm}
\DeclareMathOperator{\pro}{{p}}
\DeclareMathOperator{\PSL}{PSL}
\DeclareMathOperator{\RigSm}{RigSm}
...
%%%%%%%%% COMANDI INTRODOTTI PER SCHOLZE!!!!!!!%%%%%VALORE ASSOLUTO\newcommand{\val}{{|\cdot|}}% altrimenti non ci passa piu'%%%%SAPAZIO ADICO ASSOCIATO\newcommand{\ad}{\mathrm{ad}}%%% supporto\DeclareMathOperator{\supp}{supp}%%% Spa\DeclareMathOperator{\Spa}{Spa}%%%%
\begin{document}%
...
\begin{dfn}
A complete Hopf algebra is a complete topological augmented algebra $\epsilon\colon R\ra R/I\cong\Q$, homeomorphic to $\varprojlim R/I^k$ and endowed with a map $\Delta\colon R\ra R\hat{\otimes}R$ that fit in the usual diagrams of Hopf algebras.% and which issuch that $R$ is homeomorphic to $\varprojlim R/I^k$, where $I$ is the augmentation ideal. 
...
%There are adjoint pairs of functors
%\[
%\adj{\hat{\Q}[\cdot]}{\widetilde{\Gps}}{\cat}{\mcG}
%\]
%\[
%\adj{\hat{\mcU}}{\widetilde{\LA}}{\cat}{\mcP}
%\]
%where $\mcG$ and $\mcP$ are defined like before.
%\end{cor}
...
By Corollary \ref{univ}, we get that $\Lie G_S$ is the universal pro-nilpotent algebra associated to $LS$, i.e. its completion by the lower central series. Also, by what we proved in the first part, $G_S(\Q)=\mcG\Q\left\langle \left\langle e_1,\ldots,e_n\right\rangle\right\rangle$. %More generally, it can be computed $G_S(R)=\mcG R\left\langle \left\langle e_1,\ldots,e_n\right\rangle\right\rangle$.
